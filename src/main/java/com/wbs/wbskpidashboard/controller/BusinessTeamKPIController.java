...
public class BusinessTeamKPIController {
    ...
    public Map<String, TeamSummary> getMethodName() {
        ...
        for (BusinessTeam businessTeam : businessTeams) {
            ...
            Double avgFactoryUtilization = businessTeamKPIRepository.retreiveValue(businessTeam.getTeamName(),
                    factoryUtilization);
            Double avgEmployeeEngagement = businessTeamKPIRepository.retreiveValue(businessTeam.getTeamName(),
                    employeeEngagement);
            Double avgInterestCoverage = businessTeamKPIRepository.retreiveValue(businessTeam.getTeamName(),
                    interestCoverage);
            Double avgMarketingSpendRev = businessTeamKPIRepository.retreiveValue(businessTeam.getTeamName(),
                    marketingSpendRev);
